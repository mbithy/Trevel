...
// @name         Bot Trevel
// @version      1.1.3.0
// @description  This bot may increse your chances of winning (greatly) however I do not guarantee you absolute PROFIT, make sure you have atleast 0.00005000 btc
// @author       Mbithy Mbithy
// @website      https://freebitco.in/?r=856671
// @homepage     https://github.com/mbithy
// @updateURL    https://raw.githubusercontent.com/mbithy/Trevel/master/Trevel.js
// @downloadURL  https://raw.githubusercontent.com/mbithy/Trevel/master/Trevel.js
 ...
 *  Have fun and remember gambling is a risky adventure.
*/
$(document).ready(function(){ /*  Waiting until the page is loaded */
    /** Start show MULTIPLY BTC **/
    $("#double_your_btc_tab").show();
    $('.tabs li').removeClass('active');
    $('.tabs li').find('.double_your_btc_link').parent().addClass('active');
    /** End show MULTIPLY BTC **/
    var _stop = false,
        _rolls = 0,
